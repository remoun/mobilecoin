...
pub struct SqlRecoveryDbConnectionConfig {
    ...
    #[clap(long, default_value = "60", parse(try_from_str = parse_duration), env = "MC_POSTGRES_IDLE_TIMEOUT")]
    ...
    #[clap(long, default_value = "120", parse(try_from_str = parse_duration), env = "MC_POSTGRES_MAX_LIFETIME")]
    ...
    #[clap(long, default_value = "5", parse(try_from_str = parse_duration), env = "MC_POSTGRES_CONNECTION_TIMEOUT")]
