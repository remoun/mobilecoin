...
use mc_ledger_db::{test_utils::add_txos_and_key_images_to_ledger_db, LedgerDB};
...
pub fn test_block<T: RngCore + CryptoRng, C: FogViewConnection>(
    ...
    add_txos_and_key_images_to_ledger_db(ledger_db, BlockVersion::ZERO, txos, key_images, rng)
        .unwrap();
