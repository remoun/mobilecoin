...
fn bench_ledger_sink_for_1000_blocks(b: &mut Bencher) {
    ...
    // into
    let upstream_producer = MockStream::with_custom_block_contents(1000, 3, 1, 1);
...
fn bench_scp_validation_for_1000_blocks(b: &mut Bencher) {
    ...
    let upstream_producer = MockStream::with_custom_block_contents(1000, 3, 1, 3);
...
fn bench_validation_for_1000_blocks(b: &mut Bencher) {
    ...
    let upstream_producer = MockStream::with_custom_block_contents(1000, 3, 1, 2);
